...
const pizzas = [
    ...
    new Pizza({id: 3, name: 'Vegetariana', ingredients: 'Milho, palmito, tomate, ervilha, escarola e cebola', price: 32.00 }),
    new Pizza({id: 4, name: 'Marguerita', ingredients: 'Muçarela, manjericão e tomate', price: 37.00 }),
